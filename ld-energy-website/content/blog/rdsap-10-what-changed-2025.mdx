---
title: "RdSAP 10: What Changed in October 2025 and What It Means for Your EPC"
description: "RdSAP 10 replaced RdSAP 9.94 in October 2025 — the first major methodology update since 2012. Here's what changed, which properties are affected, and why some ratings have shifted."
...
keyTakeaways:
  - "All new EPC assessments in England and Wales must use RdSAP 10 from October 2025."
...
- The **A–G band structure** (SAP point ranges for each band)
- The **core data collection process** — assessors still visit and record the same categories of information
- The **10-year validity period** for issued certificates
- The **MEES framework** — the minimum E standard still applies; the proposed C upgrade is unchanged
...
We carry out all assessments under RdSAP 10 as required. [Book an assessment](/contact) or see our [pricing page](/pricing). For more on what the assessment process involves, see our [what happens during an EPC assessment guide](/blog/what-happens-during-epc-assessment).
