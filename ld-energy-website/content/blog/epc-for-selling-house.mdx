...
description: "Selling in England or Wales needs a valid EPC before marketing. When to get it, what rating to aim for, and how it affects your sale price."
...
keyTakeaways:
  - "A valid EPC is a legal requirement before marketing a property for sale in England and Wales."
...
faqs:
  ...
  - question: "How quickly can I get an EPC before listing?"
    answer: "With L&D Energy across London, you can typically book an assessment within one to two working days, and your certificate is lodged on the GOV.UK register within 72 hours of the visit — so within a working week from enquiry to certificate. Next-day lodgement is available for an additional £15."
...
<CTABanner heading="Need an EPC before listing?" body="We can assess your property within 1–2 days across all London boroughs, lodged within 72 hours. Guide prices from £65, exact quote before booking." />

## What rating to aim for before listing

### Currently D-rated

Check your exact SAP score first. A property near the top of band D has a short distance to travel, and the cheap measures — LED lighting and a loft insulation top-up — may be enough on their own. One near the bottom of D will need more. Your EPC recommendation report shows an indicative rating after the recommended measures for your property, which is the figure to decide from.
...
Get the EPC to confirm your exact SAP score. Then make targeted improvements. Then commission a second assessment to confirm the new rating. Cost: two assessment fees (guide prices from £65 each). Advantage: you know exactly which measures move you to the target band before spending on improvements.
