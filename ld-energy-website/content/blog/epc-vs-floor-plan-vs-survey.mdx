...
L&D Energy produces [professional floor plans](/services/floor-plans) with guide prices from £55. Because we measure every room during an EPC visit anyway, a floor plan ordered alongside an EPC saves you up to £40 against booking the two separately. One visit, one set of measurements, two documents.
...
<CTABanner heading="Selling or letting in London?" body="Guide prices from £65 for an EPC, and adding a floor plan in the same visit saves up to £40 against booking separately. Lodged within 72 hours across all 32 London boroughs." />
...
- **Better value on the plan.** Because the measurement work is already done, bundling the floor plan with an EPC saves up to £40 against booking them separately. Guide prices for each band are on the [pricing page](/pricing).
