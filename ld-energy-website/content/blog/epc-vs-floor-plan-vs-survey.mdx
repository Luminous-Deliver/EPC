...
keyTakeaways:
  - "An EPC is the only one of the three that is legally required. You must have one before marketing a property for sale or rent, and it is valid for 10 years."
  ...
  - "Landlords need at least an EPC rating of E to let under MEES, with fines of up to £5,000 for non-compliance."
  - "Because the property is measured during the EPC visit anyway, L&D Energy offers floor plans at half price when bundled with an EPC."
faqs:
  ...
  - question: "Does L&D Energy do house surveys?"
    answer: "No. House surveys must be carried out by a RICS chartered surveyor, which is a different profession from energy assessment. We provide EPCs and floor plans across all 32 London boroughs, and we are upfront that surveys are not something we offer."
relatedPosts:
...
L&D Energy provides [domestic EPCs](/services/domestic-epc) from £49 across all 32 London boroughs, with the certificate delivered within 72 hours as standard or next-day for £12 extra.
...
L&D Energy produces [professional floor plans](/services/floor-plans) from £49. Because we measure every room during an EPC visit anyway, a floor plan ordered alongside an EPC is half price. One visit, one set of measurements, two documents.
...
<CTABanner heading="Selling or letting in London?" body="Get your EPC from £49 and add a floor plan at half price in the same visit. Standard 72-hour delivery across all 32 London boroughs." />
...
| **Typical cost** | From £49 with L&D Energy | From £49, half price bundled with an EPC | Roughly £400 to over £1,000 depending on level and property |
