...
const reasons = [
  ...
  },
  {
    ...
    body:
      'Transparent guide pricing. No travel surcharges. The quote we give is the price you pay, no surprise add-ons. Book a floor plan with your EPC for better combined value.',
  },
  {
    Icon: Zap,
    title: 'Fast & Flexible',
